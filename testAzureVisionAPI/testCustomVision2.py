...
custom_vision_api_url = 'https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction/947f5a45-ef22-48b4-8cbc-65579bf57a23/image'
...
params = urllib.parse.urlencode({
    # Request parameters
    'iterationId': '099a9b31-6eb4-40e2-9a98-5937accfcb23',
})
